...
/* Iterate over the members of a STRUCT or UNION, returning each member's name,
   member type, and offset in turn.  */
...
/* Iterate over the members of an enum, returning each member's integer value,
   and passing back the name in the NAME parameter.  */
