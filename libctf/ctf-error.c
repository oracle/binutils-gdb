...
static const char *const _ctf_errlist[] = {
  ...
  "End of iteration",				     /* ECTF_NEXT_END */
  "Wrong iteration function called",		     /* ECTF_WRONGFUN */
  "Iteration entity changed in mid-iterate",	     /* ECTF_WRONGFP */
  "This feature needs a libctf with BFD support."    /* ECTF_NEEDSBFD */
};
